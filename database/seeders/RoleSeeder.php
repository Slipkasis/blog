...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admim.users.index'])->syncRoles([$role1]);
        Permission::create(['name' => 'admim.users.edit'])->syncRoles([$role1]);
        Permission::create(['name' => 'admim.users.update'])->syncRoles([$role1]);
        
        Permission::create(['name' => 'admim.categories.index'])->syncRoles([$role1]);
        Permission::create(['name' => 'admim.categories.create'])->syncRoles([$role1]);
        Permission::create(['name' => 'admim.categories.edit'])->syncRoles([$role1]);
        Permission::create(['name' => 'admim.categories.destroy'])->syncRoles([$role1]);
